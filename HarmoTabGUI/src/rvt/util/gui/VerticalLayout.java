 ...
 * when the horizontal alignment is <code>BOTH</code>
 * in which case components are stretched horizontally. Unlike FlowLayout,
 * components will not wrap to form another column if there isn't enough 
 * space vertically. VerticalLayout can optionally anchor components to the
 * top or bottom of the display area or center them between the top and bottom.
 *
...
public class VerticalLayout implements LayoutManager {
	...
	* Also used to designate center anchoring.
	*/
	...
	*/
	...
	/**
	* Constructs a VerticalLayout instance anchored to the top with
	* the specified vgap and horizontal alignment
	*
	* @param vgap An int value indicating the vertical seperation of the components
	...
	*/
	...
	/**
	* Constructs a VerticalLayout instance with the specified vgap,
